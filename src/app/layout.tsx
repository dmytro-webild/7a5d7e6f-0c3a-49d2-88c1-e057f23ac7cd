...
export const metadata: Metadata = {
  title: "ChatAI - Intelligent AI Chat Platform",  description: "Experience the future of conversation with ChatAI. Powerful AI-powered chat solutions for businesses worldwide. Real-time analytics, enterprise security, and seamless integration.",  keywords: "AI chat, chatbot, conversational AI, customer service, AI platform",  metadataBase: new URL("https://chatai.com"),
  alternates: {
    canonical: "https://chatai.com"
  },
  openGraph: {
    title: "ChatAI - Intelligent AI Chat Platform",    description: "Transform customer conversations with AI-powered chat solutions. Real-time, secure, and scalable.",    type: "website",    siteName: "ChatAI",    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3ASv6buwz6eFZpPOvFZw9u1AIJx/a-modern-ai-chat-interface-showing-a-con-1772598686660-f921ff86.png",        alt: "ChatAI Platform"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",    title: "ChatAI - Intelligent AI Chat Platform",    description: "Experience the future of conversation with ChatAI",    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3ASv6buwz6eFZpPOvFZw9u1AIJx/a-modern-ai-chat-interface-showing-a-con-1772598686660-f921ff86.png"]
  }
};
